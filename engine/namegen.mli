...
val mkProd_name : env -> evar_map -> Name.t Constr.binder_annot * types * types -> types
val mkLambda_name : env -> evar_map -> Name.t Constr.binder_annot * types * constr -> constr

(** Deprecated synonyms of [mkProd_name] and [mkLambda_name] *)
val prod_name : env -> evar_map -> Name.t Constr.binder_annot * types * types -> types
val lambda_name : env -> evar_map -> Name.t Constr.binder_annot * types * constr -> constr
