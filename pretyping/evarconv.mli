...
val the_conv_x     : env -> ?ts:Conv_oracle.oracle -> constr -> constr -> evar_map -> evar_map
val the_conv_x_leq : env -> ?ts:Conv_oracle.oracle -> constr -> constr -> evar_map -> evar_map

(** The same function resolving evars by side-effect and
   catching the exception *)
val e_conv  : env -> ?ts:Conv_oracle.oracle -> evar_map ref -> constr -> constr -> bool
val e_cumul : env -> ?ts:Conv_oracle.oracle -> evar_map ref -> constr -> constr -> bool
...
val solve_unif_constraints_with_heuristics : env -> ?ts:Conv_oracle.oracle -> evar_map -> evar_map

val consider_remaining_unif_problems : env -> ?ts:Conv_oracle.oracle -> evar_map -> evar_map
...
val second_order_matching : Conv_oracle.oracle -> env -> evar_map ->
...
(**/**)
(* For debugging *)
val evar_eqappr_x : ?rhs_is_already_stuck:bool -> Conv_oracle.oracle * bool ->
  env -> evar_map ->
