...
val splay_prod : env ->  evar_map -> constr -> (Name.t Constr.binder_annot * constr) list * constr
val splay_lam : env ->  evar_map -> constr -> (Name.t Constr.binder_annot * constr) list * constr
val splay_arity : env ->  evar_map -> constr -> (Name.t Constr.binder_annot * constr) list * ESorts.t
