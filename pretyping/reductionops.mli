...
val is_conv : ?reds:Conv_oracle.oracle -> env -> evar_map -> constr -> constr -> bool
val is_conv_leq : ?reds:Conv_oracle.oracle -> env ->  evar_map -> constr -> constr -> bool
val is_fconv : ?reds:Conv_oracle.oracle -> conv_pb -> env ->  evar_map -> constr -> constr -> bool

(** [check_conv] Checks universe constraints only.
    pb defaults to CUMUL and ts to a full transparent state.
 *)
val check_conv : ?pb:conv_pb -> ?ts:Conv_oracle.oracle -> env ->  evar_map -> constr -> constr -> bool
 ...
 *)
val infer_conv : ?catch_incon:bool -> ?pb:conv_pb -> ?ts:Conv_oracle.oracle ->
...
val infer_conv_gen : (conv_pb -> l2r:bool -> evar_map -> Conv_oracle.oracle ->
    (Constr.constr, evar_map) Reduction.generic_conversion_function) ->
  ?catch_incon:bool -> ?pb:conv_pb -> ?ts:Conv_oracle.oracle -> env ->
...
val whd_betaiota_deltazeta_for_iota_state :
  Conv_oracle.oracle -> Environ.env -> Evd.evar_map -> Cst_stack.t -> state ->
  state * Cst_stack.t
