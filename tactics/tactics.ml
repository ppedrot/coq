...
let introduction id =
  Proofview.Goal.enter begin fun gl ->
    ...
    | Prod (id0, t, b) -> unsafe_intro env store (LocalAssum ({id0 with binder_name=id}, t)) b
    | LetIn (id0, c, t, b) -> unsafe_intro env store (LocalDef ({id0 with binder_name=id}, c, t)) b
  ...
  Proofview.Goal.enter begin fun gl ->
    ...
    let sign',t,concl,sigma =
      if replace then
        ...
        let sign' = insert_decl_in_named_context sigma (LocalAssum (make_annot id r,t)) nexthyp sign' in
        sign',t,concl,sigma
      else
  ...
  Proofview.Goal.enter begin fun gl ->
    ...
    let relevance =
      try
        ...
        (** Plus we need to know the relevance *)
