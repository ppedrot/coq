...
number of nodes of the patterns matching the term. The [Conv_oracle.oracle]
...
sig
  ...
  val add : Conv_oracle.oracle option -> t -> (constr_pattern * Z.t) -> t
  val rmv : Conv_oracle.oracle option -> t -> (constr_pattern * Z.t) -> t

  val lookup : Evd.evar_map -> Conv_oracle.oracle option -> t -> EConstr.constr -> Z.t list
