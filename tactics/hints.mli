...
val create_hint_db : bool -> hint_db_name -> Conv_oracle.oracle -> bool -> unit
...
val make_local_hint_db : env -> evar_map -> ?ts:Conv_oracle.oracle -> bool -> delayed_open_constr list -> hint_db
