...
val decompose_lam_n : Evd.evar_map -> int -> EConstr.t ->
  (Names.Name.t Constr.binder_annot * EConstr.t) list * EConstr.t
val compose_lam : (Names.Name.t Constr.binder_annot * EConstr.t) list -> EConstr.t -> EConstr.t
val compose_prod : (Names.Name.t Constr.binder_annot * EConstr.t) list -> EConstr.t -> EConstr.t
