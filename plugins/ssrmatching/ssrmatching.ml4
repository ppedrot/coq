...
let glob_cpattern gs p =
  ...
  | k, (v, Some t), _ as orig ->
     ...
     match t.CAst.v with
     | CNotation((InConstrEntry,"( _ in _ )"), ([t1; t2], [], [], [])) ->
     ...
     | CNotation((InConstrEntry,"( _ in _ in _ )"), ([t1; t2; t3], [], [], [])) ->
         check_var t2; encode k "In" [fst (glob t1); bind_in t2 t3]
     | CNotation((InConstrEntry,"( _ as _ )"), ([t1; t2], [], [], [])) ->
         encode k "As" [fst (glob t1); fst (glob t2)]
     | CNotation((InConstrEntry,"( _ as _ in _ )"), ([t1; t2; t3], [], [], [])) ->
