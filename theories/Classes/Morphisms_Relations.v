...
Global Instance relation_conjunction_morphism : Proper (relation_equivalence (A:=A) ==>
  relation_equivalence ==> relation_equivalence) relation_conjunction.
  Proof. firstorder. Qed.

Global Instance relation_disjunction_morphism : Proper (relation_equivalence (A:=A) ==>
...
Global Instance relation_equivalence_pointwise :
...
Global Instance subrelation_pointwise :
