...
Global Instance eq_equiv : Equivalence Z.eq.
Proof.
split.
...
Global Instance mul_wd : Proper (Z.eq ==> Z.eq ==> Z.eq) Z.mul.
Proof.
...
Global Instance lt_wd : Proper (Z.eq ==> Z.eq ==> iff) Z.lt.
Proof.
